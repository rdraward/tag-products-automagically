 ...
 *
 * View and edit your roles and permissions in the Gadget editor at https://tag-products-automagically.gadget.app/edit/settings/permissions
 */
export const permissions: GadgetPermissions = {
  type: "gadget/permissions/v1",
  roles: {
    "automated-tests": {
      storageKey: "XokNoxeluvOO",
      models: {
        allowedTag: {
          read: true,
          actions: {
